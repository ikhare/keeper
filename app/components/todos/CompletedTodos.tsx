...
interface CompletedTodosProps {
  completedTodos: PaginationResult<WithTags<"items">[]> | undefined | null;
...
export function CompletedTodos({ 
  ...
  if (completedTodosStatus === "LoadingFirstPage") {
        ...
        <ScrollArea className="max-h-[400px]">
          <div className="p-4 space-y-2">
            <AnimatePresence mode="popLayout">
              {completedTodos && Array.isArray(completedTodos) && completedTodos.map((todo) => (
                <motion.div
                  key={todo._id}
            ...
            {(!completedTodos || !Array.isArray(completedTodos) || completedTodos.length === 0) && (
